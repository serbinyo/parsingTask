...
//$count = $fileselector->filesCount(['*.pdf']);
//$logger->info('Количество файлов:', [
//    'выбрано файлов' => $count,
//    'критерий отбора' => ['*.pdf'],
//]);

//$count = $fileselector->filesCount(['.doc', '.xls']);
//$logger->info('Количество файлов:', [
//    'выбрано файлов' => $count,
//    'критерий отбора' => ['.doc', '.xls']
//]);

$count = $fileselector->filesCount(['.xlsx']);
$logger->info('Количество файлов:', [
    'выбрано файлов' => $count,
    'критерий отбора' => ['.xlsx'],
]);
 ...
 * [2019-05-29 11:49:15] name.INFO: Количество файлов: {"выбрано файлов":46,"критерий отбора":["*.pdf"]} []
 * [2019-05-29 15:25:25] name.INFO: Количество файлов: {"выбрано файлов":0,"критерий отбора":[".doc",".xls"]} []
 * [2019-05-29 22:13:04] name.INFO: Количество файлов: {"выбрано файлов":0,"критерий отбора":[".xlsx"]} []
 */
